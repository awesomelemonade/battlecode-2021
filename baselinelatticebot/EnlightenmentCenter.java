...
import baselinelatticebot.util.Cache;
import baselinelatticebot.util.CentralCommunication;
import baselinelatticebot.util.Constants;
import baselinelatticebot.util.LambdaUtil;
import baselinelatticebot.util.MapInfo;
import baselinelatticebot.util.SlandererBuild;
import baselinelatticebot.util.Util;
    ...
    public static void buildUnit(int influence) {
        if (rc.isReady()) {
            ...
            if(turnsSincePolitician >= 10) {
                buildPolitician(Math.max(baselinelatticebot.util.Util.randBetween(16, 20), (int)(0.1*influence)));
            }
