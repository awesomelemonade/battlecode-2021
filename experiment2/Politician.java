...
import experiment2.util.LatticeUtil;
import experiment2.util.MapInfo;
import experiment2.util.Pathfinder;
import experiment2.util.UnitCommunication;
import experiment2.util.Util;
import experiment2.util.EnlightenmentCenterList.EnlightenmentCenterListNode;
...
public strictfp class Politician implements RunnableBot {
    ...
    private static void preTurn() throws GameActionException {
        ...
        int toty = 0;
        int tot = 0;
        EnlightenmentCenterListNode current = MapInfo.getKnownEnlightenmentCenterList(Constants.ALLY_TEAM).head;
        while (current != null) {
