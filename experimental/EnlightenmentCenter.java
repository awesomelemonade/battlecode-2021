...
public strictfp class EnlightenmentCenter implements RunnableBot {
    ...
    public void turn() throws GameActionException {
        ...
        if (CentralCommunication.nearestEnemy != null) {
            ...
            if(CentralCommunication.nearestEnemyDistanceSquared <= 50) {
                safetyTimer = 0;
            }
        }
    ...
    public static void buildUnit(int influence) {
        if (rc.isReady()) {
            ...
            if ((rc.getRoundNum() <= 2 || rc.getRoundNum() >= 30) && (slandererCount == 0 || random < 0.4) && safetyTimer >= 30) {
