...
public class Muckraker {
    ...
    for (RobotInfo robot : rc.senseNearbyRobots(actionRadius, enemy)) {
      if (robot.type == RobotType.ENLIGHTENMENT_CENTER) {
      	...
      	System.out.println("Found enemy EC: " + Integer.toString(enemyEC.x) + " " + Integer.toString(enemyEC.y));
	...
	public static MapLocation getExploreTarget() {
		return cur_loc.translate(directionOffX[initialExploreDirection] * 64, directionOffY[initialExploreDirection] * 64);
	}
